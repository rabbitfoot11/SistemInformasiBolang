        ...
        <div class="container py-5">
            <div class="row align-items-center py-4">
                <div class="col-md-6 text-center text-md-left">
                    <h1 class="display-4 mb-4 mb-md-0 text-secondary text-uppercase">Aceh</h1>
                </div>
                <div class="col-md-6 text-center text-md-right">
                    <div class="d-inline-flex align-items-center">
                        <a class="btn btn-sm btn-outline-light" href="">Budaya</a>
                        <i class="fas fa-angle-double-right text-light mx-2"></i>
                        <a class="btn btn-sm btn-outline-light disabled" href="">Aceh</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row align-items-end mb-4">
                <div class="col-lg-6">
                    ...
                    <h1 class="section-title mb-3">Nangroe Aceh Darusallam</h1>
                </div>
                <div class="col-lg-6">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 mb-5">
                    <div class="position-relative mb-4">
                        <img class="img-fluid rounded w-100" src="img/b1aceh.jpg" alt="">
                        <div class="blog-date">
                    ...
                    <h5 class="font-weight-medium mb-2">Upacara Peusijeuk</h5>
                    <p class="mb-4">Peusijuek merupakan upacara adat Aceh yang bertujuan sebagai..</p>
                    <a class="btn btn-sm btn-primary py-2" href="/k1aceh">Read More</a>
                </div>
                <div class="col-lg-4 col-md-6 mb-5">
                    <div class="position-relative mb-4">
...
</html><?php /**PATH C:\xampp\htdocs\bolang\resources\views/budaya/aceh.blade.php ENDPATH**/ ?>