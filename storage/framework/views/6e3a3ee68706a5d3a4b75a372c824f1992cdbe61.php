            ...
            <div class="row align-items-center py-4">
                ...
                <div class="col-md-6 text-center text-md-right">
                    <div class="d-inline-flex align-items-center">
                        <a class="btn btn-sm btn-outline-light" href="/aceh">Aceh</a>
                ...
                <div class="col-lg-8">
                    <div class="mb-5">
                        <div class="d-flex mb-2">
                            ...
                            <a class="text-secondary text-uppercase font-weight-medium" href="">Aceh</a>
                            <span class="text-primary px-2">|</span>
                            <a class="text-secondary text-uppercase font-weight-medium" href="">September 20, 2022</a>
                        </div>
                        <h1 class="section-title mb-3">Upacara Peusijuek</h1>
                    </div>

                    <div class="mb-5">
                        <img class="img-fluid rounded w-100 mb-4" src="img/k1aceh.jpg" alt="Image">
                        <p>Peusijuek merupakan upacara adat Aceh yang bertujuan sebagai bentuk rasa syukur kepada Tuhan Yang Maha Esa. 
                        Upacara ini dilakukan oleh masyarakat Aceh karena harapannya telah tercapai. Upacara Peusijuek lazim dilakukan 
                        saat prosesi pernikahan, hendak berangkat naik haji, pergi menuntut ilmu, naik pangkat, memiliki rumah baru, 
                        memiliki kendaraan baru, dan lain sebagainya. Pada pelaksanaannya, upacara dipimpin oleh tokoh agama dan adat setempat. 
                        Ia akan memimpin doa-doa keselamatan dan kesejahteraan kepada Tuhan Yang Maha Esa.</p>
                        <p>Peusijuek berasal dari bahasa Aceh yang berarti menjadi dingin atau mendinginkan. 
                            Upacara adat Peusijuek berawal saat Aceh menerima ajaran Islam pada abad ke tujuh oleh pedagang dari Arab. 
                            Proses pengenalan Islam dilakukan secara damai dan tanpa penaklukan.Kemudian, terjadilah pembaruan budaya, 
                            yaitu Islam dan budaya masyarakat Aceh. Pembaruan ini menghasilkan budaya baru, yaitu peusijuek.</p>
...
</html><?php /**PATH C:\xampp\htdocs\bolang\resources\views/aceh/konten1.blade.php ENDPATH**/ ?>