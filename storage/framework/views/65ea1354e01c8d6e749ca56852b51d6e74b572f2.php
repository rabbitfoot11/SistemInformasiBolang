                ...
                <nav class="navbar navbar-expand-lg bg-white navbar-light p-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="/kontak" class="nav-item nav-link active">Hubungi</a>
                        </div>
        ...
        <div id="header-carousel" class="carousel slide carousel-fade" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="img-fluid" src="img/tim-bolang.jpg" alt="Image">
                    <div class="carousel-caption d-flex align-items-center justify-content-center">
                    <div class="container py-5">
            <div class="row align-items-center py-4">
                <div class="col-md-6 text-center text-md-left">
                    <h1 class="display-4 mb-4 mb-md-0 text-secondary text-uppercase">Hubungi</h1>
                </div>
                <div class="col-md-6 text-center text-md-right">
                    <div class="d-inline-flex align-items-center">
                        <a class="btn btn-sm btn-outline-light" href="">Home</a>
                        <i class="fas fa-angle-double-right text-light mx-2"></i>
                        <a class="btn btn-sm btn-outline-light disabled" href="">Hubungi</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row align-items-end mb-4">
                <div class="col-lg-6">
                    ...
                    <h1 class="section-title mb-3">Hubungi Kami untuk pemesanan atau tentang Bolang</h1>
                </div>
                <div class="col-lg-6">
            ...
            <div class="row">
                ...
                <div class="col-lg-5" style="min-height: 400px;">
                    <div class="position-relative h-100 rounded overflow-hidden">
                        ...
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3958.5058211817145!2d112.64436232172278!3d-7.182975378226353!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd80024a988fcc9%3A0x36e185f754a3686b!2sJl.%20Veteran%2C%20Kabupaten%20Gresik%2C%20Jawa%20Timur!5e0!3m2!1sid!2sid!4v1663640985000!5m2!1sid!2sid"
...
</html><?php /**PATH C:\xampp\htdocs\bolang\resources\views/pages/kontak.blade.php ENDPATH**/ ?>